...
const App = () => {
  ...
  const dataDisplay = isTabletOrMobile ? <CardList data-test="component-card-list" data={deals} /> : <DynamicTable data-test="component-dynamic-table" columns={columns} clicked={clickHandler} rows={deals} />;
